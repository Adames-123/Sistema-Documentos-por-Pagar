...
namespace SistemaCuentasPorPagarAPI.Controllers
{
    ...
    [ApiController]
    public class Proveedors1Controller : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public Proveedors1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
